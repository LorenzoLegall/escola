<html>
    <head>
        ...
        <title> Agenda de contatos T-30 - SALVAR </title>
        <style>
            body{
            ...
            <div style="text-align: center;">
                <div style="text-align: left; display:inline-block;">
                    <span class="denise" style="position:relative; height: 40px; width: 40px; display:inline-block; vertical-align:middle;" onmouseover="document.getElementById('hugo').style.opacity=0; document.getElementById('bu').style.opacity=1;" onmouseout="document.getElementById('hugo').style.opacity=1; document.getElementById('bu').style.opacity=0;">
                        ...
                        <img src="bu.png" id="bu" style="position:absolute; height: 40px; width: 40px; opacity: 0; top:0; left:0; z-index:1; cursor:pointer;" onclick="window.location.href='salvar_old.php';">
                    </span>
        ...
        <?php
            ...
            if(mysqli_query($conexao, $sql)){
                echo "<div style='background-color:#0D0F12; width:500px; margin:0 auto; border-radius:15px; box-shadow: 0 0 10px rgba(47, 221, 163, 0.6); padding:20px; text-align:center;'>
                        <h2 style='color:#818898; font-size:20px; margin-top:10px;'> CONTATO ADICIONADO COM SUCESSO! </h2> <br>";
                ...
                echo "<div style='background-color:#0D0F12; width:500px; margin:0 auto; border-radius:15px; box-shadow: 0 0 10px rgba(47, 221, 163, 0.6); padding:20px; text-align:center;'>
                        <h2 style='color:#818898; font-size:20px; margin-top:10px;'> ERRO AO ADICIONAR CONTATO" . mysqli_error($conexao);"</h2> <br>";
