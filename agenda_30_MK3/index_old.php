<html>
    ...
    <body>
        ...
        <div class="clippy" style="background-color:#FFFFFF; position: fixed; bottom: 20px; right: 20px; z-index: 10;">
            <div id="clippy_bubble" style="bottom:200px; right: 0; position: absolute; background-color: #FFFFCC; border-radius: 10px; border: 2px solid #000000; padding: 8px; font-weight: 50; max-width: 200px; word-wrap: break-word;"></div>
            <img src="img-clippy/clippy_base.gif" height="200px" id="clippy_image" alt="Clippy" style="bottom: 20px; right: 20px; z-index: 10;">
        </div>
        <script src="z_clippy_cerebro.js"></script>
    </body>
</html>