<html>
    ...
    <body>
        ...
        <div style="text-align: center;">
            <div style="text-align: left; display:inline-block;">
                <span class="denise" style="position:relative; height: 40px; width: 40px; display:inline-block; vertical-align:middle;" onmouseover="document.getElementById('hugo').style.opacity=0; document.getElementById('bu').style.opacity=1;" onmouseout="document.getElementById('hugo').style.opacity=1; document.getElementById('bu').style.opacity=0;">
                    ...
                    <img src="bu.png" id="bu" style="position:absolute; height: 40px; width: 40px; opacity: 0; top:0; left:0; z-index:1; cursor:pointer;" onclick="window.location.href='editar_old.php';">
                </span>
        ...
        <div class="cafe_pele" style="background-color:#0D0F12; width:450px; margin:0 auto; border-radius:15px; box-shadow: 0 0 10px rgba(47, 221, 163, 0.6); padding:20px;">     
