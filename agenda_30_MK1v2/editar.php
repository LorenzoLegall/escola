<html>
    ...
    <body>
        ...
        <div class="cafe_pele" style="background-color:#0D0F12; width:450px; margin:0 auto; border-radius:15px; box-shadow: 0 0 0 0.3px #818898; padding:20px;">     
            ...
            <form method="post" action="atualizado.php" style="color:#f8f8ff;">
                <input type="hidden" name="id" value="<?php echo $contato['id']; ?>">
                <p style="color:#818898; font-weight: 600; font-size:18px;"> Nome: </p> <input type="text" name="nome" style="width:100%; box-sizing:border-box; background-color:#2a2a2a; color: #FFFFFF; padding:10px; box-shadow: 0 0 0 0.5px #818898; border: none; border-radius:4px;" value="<?php echo $contato['nome']; ?>" required><br><br>
                <p style="color:#818898; font-weight: 600; font-size:18px;"> Endereço: </p> <input type="text" name="endereco" style="width:100%; box-sizing:border-box; background-color:#2a2a2a; color: #FFFFFF; padding:10px; box-shadow: 0 0 0 0.5px #818898; border: none; border-radius:4px;" value="<?php echo $contato['endereco']; ?>" required><br><br>
                <p style="color:#818898; font-weight: 600; font-size:18px;"> Telefone: </p> <input type="text" name="fone" style="width:100%; box-sizing:border-box; background-color:#2a2a2a; color: #FFFFFF; padding:10px; box-shadow: 0 0 0 0.5px #818898; border: none; border-radius:4px;" value="<?php echo $contato['telefone']; ?>" minlength="14" maxlength="15" oninput="mascaraTelefone(event)" required><br><br>
